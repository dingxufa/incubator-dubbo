 ...
 */
    ...
    public ServiceAnnotationBeanPostProcessor(String... packagesToScan) { // 构造方法
    ...
    private void registerServiceBeans(Set<String> packagesToScan, BeanDefinitionRegistry registry) {
        ...
        //DubboClassPathBeanDefinitionScanner 对象。它是用于扫描指定包下符合条件的类，用于将每个符合条件的类，创建对应的 BeanDefinition 对象，从而创建 Bean
    ...
    private BeanNameGenerator resolveBeanNameGenerator(BeanDefinitionRegistry registry) {
        ...
        if (registry instanceof SingletonBeanRegistry) {
            SingletonBeanRegistry singletonBeanRegistry = SingletonBeanRegistry.class.cast(registry);// 将regitery 转为SingletonBeanRegistry类型
     ...
     *
     * <p></>
     * 使用StringBuilder拼装字符串  返回  ServiceBean:${interfaceClassName}:${version}:${group}
     *
     * @param service
